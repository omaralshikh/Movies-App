...
/*
 ...
 -----------------------------------------------------
 */
public func getNowPlayingMoviesFromApi() {
    ...
    let jsonDataFromApi = getJsonDataFromApi(apiUrl: "https://api.themoviedb.org/3/movie/now_playing?api_key=9130acef02325a467bb2808b39e5e341")
        ...
        do {
            ...
            for index in 0..<arrayOfHitsJsonObjects.count {
                ...
                nowPlayingList.append(foundMovie)
